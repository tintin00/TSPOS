...
namespace TS.Dev.Test2
{
    internal static class Program
    {
        ...
        private static void Main()
        {
            ...
            DataDirectoryHelper.LocalPrefix = "TSDev";
            bool exit;
            using (IDisposable singleInstanceApplicationGuard = DataDirectoryHelper.SingleInstanceApplicationGuard("TSDevApp", out exit))
            {
                if (exit) return;
                ...
                ((DevExpress.LookAndFeel.Design.UserLookAndFeelDefault)DevExpress.LookAndFeel.Design.UserLookAndFeelDefault.Default).LoadSettings(() =>
                {
                    var skinCreator = new SkinBlobXmlCreator("HybridApp",
                        "TS.Dev.Test2.SkinData.", typeof(Program).Assembly, null);
        ...
        {
            get { return DevExpress.Utils.ResourceImageHelper.CreateIconFromResourcesEx("TS.Dev.Test2.Resources.AppIcon.ico", typeof(MainForm).Assembly); }
        }
